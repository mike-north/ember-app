...
function detectFileType(fileName: string): FileType {
  if (/.js$/.test(fileName)) return FileType.JavaScript;
  if (/.ts$/.test(fileName)) return FileType.TypeScript;
  if (/.html$/.test(fileName)) return FileType.HTML;
  if (/.css$/.test(fileName)) return FileType.CSS;
  if (/.scss$/.test(fileName)) return FileType.SCSS;
  if (/.json$/.test(fileName)) return FileType.JSON;
