...
@suite('Integration | Component | project-editor/file-tree')
export class ProjectEditorFileTreeComponentTest extends EmberRenderingTest {

  @test async 'it renders when used in {{inline-form}}'(assert: Assert) {
    // Set any properties with this.set('myProperty', 'value');
    // Handle any actions with this.set('myAction', function(val) { ... });

    await render(hbs`{{project-editor/file-tree}}`);
